...
# Lista de livros (vazia – o banco preenche depois)
lista = tk.Listbox(janela, width=52, height=6)
lista.pack(padx=10)

# Campo de digitação (usado pelo emprestar)
...
def excluir():
    ...
    atualizar_lista()
    resultado.config(text="Excluido: " + livro.titulo, fg="blue")
...
# Botões Excluir e Alterar (num Frame)
...
# Primeira carga da tela: o banco preenche a lista
atualizar_lista()
