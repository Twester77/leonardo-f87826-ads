# =============================================================================
#  janela.py  —  a janela com formulario de cadastro (encontro 9)
# =============================================================================
...
def emprestar():
    ...
    emprestimo = Emprestimo(escolhido, usuario, "31/08/2026")
...
def cadastrar():
    ...
    try:
        ...
        # a mensagem e a que a SUA classe escreveu no raise
        resultado.config(text=str(erro), fg="red")
